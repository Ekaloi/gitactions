...
class Calculator {
    ...
    String createUniqueID(String n){
        ...
        for (int i = 0; i < 10; i++) { // Generate a random suffix
            uniquePart.append((char) (random.nextInt(26) + 'a')); // Random lowercase letters
        }
        uniquePart.append(random.nextInt(10000)); // Append random number
        return n + uniquePart.toString();
    }
